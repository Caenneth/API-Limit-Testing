...
public class Graph {
    public static void CreateGraph(string platform, string timestamp) 
    {
        ProcessStartInfo start = new ProcessStartInfo();
        start.FileName = @"C:\Python310\python.exe"; // Pfad zur Python-Installation
        start.Arguments = string.Format("{0} {1} {2}", "./source/graph/graphic.py", platform, timestamp); // Pfad zur Python-Datei und Zeitstempel
